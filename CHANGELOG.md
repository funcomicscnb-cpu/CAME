...
- Known limitations: stub-mode validation is the release gate, real-mode production readiness depends on caller-provided data and tools, and authorship/repository/release-date citation fields still require final public-release decisions.
